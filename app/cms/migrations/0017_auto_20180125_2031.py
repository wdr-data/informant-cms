    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                related_name="report", to="cms.Genre", verbose_name="Genre"
            ),
        ),
        migrations.AlterField(
            model_name="report",
        ...
        migrations.AlterField(
            ...
            name="genres",
            field=models.ManyToManyField(
                related_name="wiki", to="cms.Genre", verbose_name="Genre"
            ),
        ),
        migrations.AlterField(
            model_name="wiki",
            name="tags",
            field=models.ManyToManyField(
                blank=True, related_name="wiki", to="cms.ReportTag", verbose_name="Tags"
            ),
        ),
        migrations.AlterField(
            model_name="wiki",
